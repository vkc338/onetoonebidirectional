...
public class HibernateUtil 
{
	...
	public static SessionFactory getSessionFactory()
	{
		...
		settings.put(Environment.URL,"jdbc:mysql://localhost:3307/QuestionsAns");
		...
		MetadataSources mds= new MetadataSources(registry).addAnnotatedClass(Question.class).addAnnotatedClass(Answer.class);
