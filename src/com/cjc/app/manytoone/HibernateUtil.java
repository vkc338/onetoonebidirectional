...
public class HibernateUtil 
{
	...
	public static SessionFactory getSessionFactory()
	{
		...
		settings.put(Environment.URL,"jdbc:mysql://localhost:3307/ManyEMployee");
		...
		MetadataSources mds= new MetadataSources(registry).addAnnotatedClass(Employee.class).addAnnotatedClass(CompanyAddress.class);
